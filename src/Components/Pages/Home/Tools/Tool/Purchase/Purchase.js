...
const Purchase = () => {
  ...
  return (
    <div>
      <div className='container mx-auto my-20 text-white px-6'>
        <div className='grid grid-cols-1 lg:grid-cols-6 gap-12'>
          <div className='lg:col-span-4'>
            <div className='grid py-10 lg:px-8  px-4 lg:grid-cols-3 bg-gradient-to-r bg-secondary to-primary gap-5 rounded-3xl w-full'>
              ...
              <div className='col-span-2 lg:px-10 md:px-8 px-3'>
                <h2 className='text-3xl font-semibold mt-5 lg:mt-0 '>
                  {tool.name}
                </h2>
                <p className='mt-4 whitespace-pre-wrap'>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Reiciendis vitae dolore aliquid ratione! Libero nihil deserunt
                  voluptates. Dolor, quis natus.
                </p>
                ...
                <button
                  ...
                  className='relative bottom-0 ml-auto  mt-10 -mr-7 modal-button inline-block px-6 py-2 border-[1px] border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out'
                >
                  Place Order
                </button>
              </div> */}
          ...
          <div className='lg:col-span-2 '>
            <PlaceOrder user={user} tool={tool} inputQuantity={inputQuantity} />
          </div>
        </div>
